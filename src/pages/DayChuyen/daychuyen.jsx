...
const DayChuyenPage = () => {
  // 1. Chỉ định rõ loại danh mục cho trang này là 'day-chuyen'
  const categoryType = "day-chuyen";

  // 2. Cài đặt đường dẫn ảnh banner dành riêng cho trang Dây Chuyền
  const currentBanner = "/banners/banner-day-chuyen.jpg";
    ...
    <div className="product-page-container">
      ...
      <div className="container">
        ...
        <section className="category-section">
          {/* Truyền tờ giấy ghi chú 'day-chuyen' cho CategoryList */}
